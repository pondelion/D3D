...
protected:
	...
	IDirect3DTexture9	*mSphereTex, *mLTGridTex, *mLTBoxTex, *mLTSpringTex, *mRedTex,*mGreenTex, *mBlueTex;
	...
	D3DXVECTOR3 mSpringScale,mSphereScale;
	float mCamSpeed;
...
public:
	...
	void drawLTArrow(D3DXVECTOR3& pos,float size,D3DXMATRIX& R,IDirect3DTexture9* tex);
